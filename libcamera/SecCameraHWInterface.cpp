...
void CameraHardwareSec::initDefaultParameters(int cameraId)
{
    ...
    p.set("iso-values", "auto,ISO50,ISO100,ISO200,ISO400,ISO800,ISO1600,ISOSPORTS,ISONIGHT,ISOMOVIE");
    p.set("iso", "auto");
...
status_t CameraHardwareSec::setParameters(const CameraParameters& params)
{
    ...
    if (new_iso_str != NULL) {
        ...
        if (!strcmp(new_iso_str, "auto")) {
            ...
            new_iso = ISO_1600;
        } else if (!strcmp(new_iso_str, "ISOSPORTS")) {
            new_iso = ISO_SPORTS;
        } else if (!strcmp(new_iso_str, "ISONIGHT")) {
            new_iso = ISO_NIGHT;
        } else if (!strcmp(new_iso_str, "ISOMOVIE")) {
            new_iso = ISO_MOVIE;
        } else {
