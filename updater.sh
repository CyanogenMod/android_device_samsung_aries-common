...
if /tmp/busybox test "$1" = cdma ; then
    ...
    MMC_PART='/dev/block/mmcblk0p1'
    MMC_SIZE='1175M' # MMC partition size minus the 400MB for system
    MTD_SIZE='490733568'
else
    # GSM mode
    ...
    MMC_SIZE='XXXX' # I dunno what this should be for GSM devices
    MTD_SIZE='442499072'
fi
